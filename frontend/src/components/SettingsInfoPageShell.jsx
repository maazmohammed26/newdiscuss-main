...
export default function SettingsInfoPageShell({ title, description, icon: Icon, children }) {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-950 dark:bg-black dark:text-white">
      <header className="sticky top-0 z-40 border-b border-neutral-200/80 bg-white/90 backdrop-blur-xl dark:border-neutral-800 dark:bg-black/90">
        <div className="mx-auto flex h-16 max-w-3xl items-center justify-between px-4 sm:px-6">
          <Link
            to={backTarget}
            className="inline-flex min-h-10 items-center gap-2 rounded-full px-2 text-sm font-bold text-neutral-800 transition-colors hover:bg-neutral-100 dark:text-neutral-100 dark:hover:bg-neutral-900"
          >
      ...
      <main className="mx-auto w-full max-w-2xl px-5 pb-20 pt-10 sm:px-6 sm:pt-14">
        <div className="mb-10 flex items-start gap-4">
          <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-neutral-100 dark:bg-neutral-900">
            <Icon className="h-5 w-5 stroke-[1.8px] text-neutral-950 dark:text-white" />
          </div>
          <div>
