  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 border border-neutral-200 dark:border-neutral-700 discuss:border-white/10 text-neutral-700 dark:text-neutral-300 dark:text-neutral-300 text-[12px] font-bold transition-colors"
        title="Download CSV"
      >
